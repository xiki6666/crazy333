...
scrollFrame.Size = UDim2.new(1, -10, 1, -185) -- Увеличил отступ снизу для новых элементов
...
instruction.Position = UDim2.new(0, 5, 1, -90) -- Над переключателем режимов
...
modeSwitchFrame.Position = UDim2.new(0, 5, 1, -45) -- В самом низу фрейма
